...
*/
    ...
    return(
        ...
        <div className='relative flex justify-center items-center sm:w-9/12 '>
            ...
            <div className="container absolute w-9/12 h-16 bg-gray-800 border-4 border-white rounded-xl shado flex flex-row justify-between items-center text-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:shadow-2xl duration-300 delay-0 shadow-md ">
