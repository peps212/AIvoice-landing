...
const Form = () => {
    ...
    return (
    <form onSubmit={handleFormSubmit} class="flex w-full items-end py-3 md:justify-normal justify-center" >
        ...
        <button disabled={buttonLoading} class="inline-flex text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-blue-800 rounded text-lg shadow-2xl">Join</button>
    </form>
    )
}
